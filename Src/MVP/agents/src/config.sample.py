...
class Settings(BaseSettings):
    ...
    Note:
        ...
        values defined in this class. Supports .env file configuration via pydantic-settings.
    ...
    Raises:
        RuntimeError: If LLM_API_KEY is missing and the provider is not Bedrock.
    """
