...
import { type AxiosError, apiClient } from "../api/client";
    ...
    <div className="flex flex-col gap-6 p-6">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-sm text-gray-500">
          Il modello che l&apos;Agente Docs segue quando genera o aggiorna un README. Senza un
          template personalizzato viene usato quello di default.
        </p>
      </header>
      ...
      <section className="flex flex-col gap-2">
        <label htmlFor="file-template" className="text-sm font-medium text-[#2a2a2a]">
