    ...
    <div className="rounded border border-[#cccccc] bg-white overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <span className="block text-sm font-semibold text-[#2a2a2a]">{block.category}</span>
          <span className="block text-xs text-gray-500 truncate">
            {block.filePath} · righe {block.lineStart}–{block.lineEnd}
          </span>
        </div>
      ...
      {expanded && (
        <div className="border-t border-[#cccccc] divide-y divide-[#eeeeee] px-4 py-3 bg-gray-50">
          <div className="pb-3">
            ...
            <p className="mt-1 text-sm text-[#2a2a2a] leading-relaxed">{block.description}</p>
          </div>
          <div className="pt-3">
