  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        ...
        <span
          className={`px-2.5 py-0.5 text-xs font-bold uppercase rounded-full border ${badgeClass}`}
        >
          {block.severity}
        </span>
      </div>
      ...
      <div className="text-sm font-mono text-gray-500 bg-gray-50 p-2.5 rounded border border-gray-100">
        ...
        <strong>Righe:</strong> {block.startLine} - {block.endLine}
      </div>
