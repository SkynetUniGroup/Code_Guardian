...
Servizio esterno basato su intelligenza artificiale previsto per lo sviluppo del progetto. Fornisce i modelli linguistici di grandi dimensioni (LLM) utilizzati dagli agenti per elaborare e produrre l'output richiesto.
\vspace{0.5cm}
...
Strumento di Anthropic le cui API vengono integrate nel progetto per eseguire le analisi avanzate. L'Agente OWASP interroga specificamente queste API per identificare vulnerabilità standard nel codice (OWASP Top 10) e verificare l'aderenza del codice alle policy interne di sviluppo sicuro.
\vspace{0.5cm}
