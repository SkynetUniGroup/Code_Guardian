...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{1.0.1} \\ \hline
            \textbf{Uso} & \textit{Interno} \\ \hline
            \textbf{Redattori} & \textit{Sara Ristovic, Dario Pirrone, Andrea Fistarol, Marco Barbiero} \\ \hline
            \textbf{Verifica} & \textit{Marco Barbiero, Samuele Bertin, Sara Ristovic, Edoardo Granziero} \\ \hline
            \textbf{Approvazione} & \textit{Edoardo Granziero, Andrea Fistarol} \\ \hline
...
Evento che avvia automaticamente l'esecuzione di un processo. Nel contesto dei \textit{Use Case}, identifica l'evento che dà inizio allo scenario descritto; nel contesto della \textit{Continuous Integration}, identifica l'evento (ad esempio una \textit{Pull Request}) che avvia automaticamente una pipeline di \textit{GitHub Actions}.
\vspace{0.5cm}
