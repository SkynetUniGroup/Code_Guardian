...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|p{2.2cm}|p{2.2cm}|p{2.2cm}|}
        ...
        1.0.2 & 2026/09/05 & Aggiunta di altri termini da NdP e PdP & Samuele Bertin & Dario Pirrone & Dario Pirrone \\ \hline
        1.0.1 & 2026/08/21 & Rimossa la numerazione dall'indice, come suggerito dal Prof. Vardanega & Marco Barbiero & Dario Pirrone & \textemdash \\ \hline
        1.0.0 & 2026/08/13 & Aggiunta di altri termini e allineamento per RTB & Andrea Fistarol & Edoardo Granziero & \textemdash \\ \hline
        0.2.0 & 2026/07/07 & Verifica dettagliata del documento intero & Sara Ristovic & \textemdash & \textemdash \\ \hline
        0.2.0 & 2026/05/22 & Inseriti primi termini & Dario Pirrone & Samuele Bertin & \textemdash \\ \hline
        0.1.0 & 2026/04/03 & Stesura della sezione "Introduzione" & Sara Ristovic & Marco Barbiero & \textemdash \\ \hline
        \end{tabularx}
\end{table}
