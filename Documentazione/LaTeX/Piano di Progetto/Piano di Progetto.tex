...
\begin{titlepage}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{0.6} \\ \hline
...
I ruoli assegnati sono: \textbf{Responsabile}, \textbf{Amministratore}, \textbf{Analista} e
\textbf{Verificatore}.
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3}
...
\subsubsection{\textit{Sprint} 4: 12/05/2026 - [Data di fine]}
...
I ruoli assegnati sono: \textbf{Responsabile}, \textbf{Amministratore}, \textbf{Analista}, \textbf{\glo{Progettista}{progettista}}, \textbf{Programmatore} e \textbf{Verificatore}.
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3}
    \begin{tabularx}{0.9\textwidth}{|X|c|c|c|c|c|c|c|}
