...
Il progetto è stato diviso in due \textbf{\glo{macro-fasi}{macro-fasi}} principali, ognuna associata a una milestone di revisione fondamentale per valutare l'avanzamento dei lavori e la qualità dei prodotti realizzati:
...
\begin{itemize}
    ...
    \item Sviluppo \textbf{\glo{Frontend}{frontend}}, \textbf{\glo{Backend}{backend}} e Architettura del \textit{PoC}
...
\begin{itemize}
    \item sviluppo completo e verifica del \textit{PoC}
...
\begin{table}[H]
    ...
    \end{tabularx}
    \caption{Preventivo orario - \textit{Sprint} 8}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|c|c|c|c|c|c|c|}
        ...
        \textbf{Costo totale} & \EUR{} & \EUR{} & \EUR{} & \EUR{} & \EUR{} & \EUR{} & \textbf{\EUR{}} \\ \hline
    \end{tabularx}
    \caption{Preventivo economico - \textit{Sprint} 8}
\end{table}
