...
\begin{itemize}
    \item Verifica complessiva e adeguamento dei vari documenti in sviluppo, con un controllo dei collegamenti tra documenti e con i termini del \textbf{Glossario}, oltre ad un controllo contenutisito per alcune sezioni;
    \item Preparazione della presentazione per l'\textbf{RTB}: creare le slide e di conseguenza decidere l'ordine di esposizione dei vari contenuti;
    \item Aggionramento del sito e dei vari PDF dei documenti esposti su di esso, portando il documento di \textbf{AdR} alla versione 1.0.0.
\end{itemize}
