...
\begin{titlepage}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{1.2.1} \\ \hline
...
\begin{xltabular}{\textwidth}{|c|c|X|p{2.3cm}|p{2.3cm}|p{2.3cm}|}
    \hline
    \textbf{Ver.} & \textbf{Data} & \textbf{Descrizione} & \textbf{Autore} &
    \textbf{Verificatore} & \textbf{Approvatore}  \\ \hline
    \endfirsthead

    \hline
    \textbf{Ver.} & \textbf{Data} & \textbf{Descrizione} & \textbf{Autore} & \textbf{Verificatore} & \textbf{Approvatore} \\ \hline
    \endhead
        1.2.1 & 2026/08/21 & Aggiunta versione al riferimento del glossario e aggiunta data di accesso alle risorse web di riferimento & Marco Barbiero & Dario Pirrone & Nome Cognome \\ \hline
        1.2.0 & 2026/08/18 & \textit{Consuntivo} \textit{sprint} 12 e \textit{Preventivo sprint} 13 & Andrea Fistarol & Dario Pirrone & Nome Cognome\\ \hline
        1.1.0 & 2026/08/13 & \textit{Consuntivo} \textbf{RTB} e \textit{Preventivo sprint} 12 & Andrea Fistarol & Marco Barbiero & Nome Cognome\\ \hline
        1.0.0 & 2026/08/10 & \textit{Consuntivo sprint} 11 e correzioni per revisione RTB & Andrea Fistarol & Edoardo Granziero & Nome Cognome\\ \hline
        0.14.0 & 2026/08/07 & Correzione e adeguamento della sezione \textit{3 Pianificazione} & Sara Ristovic & Andrea Fistarol & Nome Cognome\\ \hline 
        0.13.1 & 2026/08/05 & Implementazione delle correzioni della verifica dettagliata & Sara Ristovic & Samuele Bertin & Nome Cognome\\ \hline 
        0.13.0 & 2026/08/05 & Scrittura \textit{consuntivo} \textit{sprint} 10 e \textit{preventivo} \textit{sprint} 11 & Dario Pirrone & Sara Ristovic & Nome Cognome\\ \hline
        0.12.0 & 2026/07/25 & Scrittura \textit{consuntivo} \textit{sprint} 9 e \textit{preventivo} \textit{sprint} 10 & Sara Ristovic & Edoardo Granziero & Nome Cognome\\ \hline
        0.11.0 & 2026/07/17 & Scrittura \textit{consuntivo} \textit{sprint} 8 e \textit{preventivo} \textit{sprint} 9 & Marco Barbiero & Dario Pirrone & Nome Cognome\\ \hline
        0.10.0 & 2026/07/09 & Scrittura \textit{consuntivo} \textit{sprint} 7 e \textit{preventivo} \textit{sprint} 8 & Sara Ristovic & Dario Pirrone & Nome Cognome\\ \hline
        0.9.0 & 2026/07/02 & Scrittura \textit{consuntivo} \textit{sprint} 6 e \textit{preventivo} \textit{sprint} 7 & Samuele Bertin & Sara Ristovic & Nome Cognome\\ \hline
        0.8.0 & 2026/06/18 & Scrittura \textit{consuntivo} \textit{sprint} 5 e \textit{preventivo} \textit{sprint} 6 & Samuele Bertin & Sara Ristovic & Nome Cognome\\ \hline
        0.7.0 & 2026/05/29 & Scrittura \textit{consuntivo} \textit{sprint} 4 e \textit{preventivo} \textit{sprint} 5; Descritto il nuovo rischio RO3 & Sara Ristovic & Edoardo Granziero & Nome Cognome\\ \hline
        0.6.0 & 2026/05/21 & Scrittura capitolo 3: Pianificazione & Edoardo Granziero & Samuele Bertin & Nome Cognome\\ \hline
        0.5.0 & 2026/05/19 & Scrittura \textit{preventivo} \textit{sprint} 4, scrittura \textit{consuntivo} \textit{sprint} 3 & Edoardo Granziero & Samuele Bertin & Nome Cognome\\ \hline
        0.4.0 & 2026/05/06 & Scrittura \textit{preventivo} \textit{sprint} 3, scrittura \textit{consuntivo} \textit{sprint} 2, grafico burndown & Samuele Bertin & Dario Pirrone & Nome Cognome\\ \hline
        0.3.0 & 2026/04/27 & Stesura capitolo 2: Analisi dei Rischi & Dario Pirrone & Marco Barbiero & Nome Cognome\\ \hline
        0.2.0 & 2026/04/22 & Scrittura \textit{preventivo} \textit{sprint} 1 e \textit{sprint} 2, scrittura \textit{consuntivo} \textit{sprint} 1 & Dario Pirrone & Marco Barbiero & Nome Cognome\\ \hline
        0.1.0 & 2026/04/12 & Scrittura della sezione ``Introduzione'' & Sara Ristovic & Marco Barbiero & Nome Cognome\\ \hline
        0.0.1 & 2026/04/11 & Strutturazione del documento & Dario Pirrone & Marco Barbiero & Nome Cognome\\ \hline
...
\begin{table}[H]
    \centerline{
        ...
        \begin{tabularx}{1.1\textwidth}{|m{5em}|p{11em}|p{7.5em}|X|}
            ...
            \hline \hline
            \multirow{5}{*}[-2cm]{\centering \textbf{PB}} & Progettazione architetturale & 19 agosto & - Progettazione della struttura software basata sulle tecnologie scelte. \newline
            ...
            \cline{2-4}
            & Test e raffinamento & 4 settembre & - Esecuzione dei \textit{Test di Sistema} e correzione dei \textit{bug}. \newline
