...
\begin{xltabular}{\textwidth}{|c|c|X|p{2.3cm}|p{2.3cm}|p{2.3cm}|}
    ...
    \endhead
        1.4.0 & 2026/09/06 & \textit{Consuntivo} \textit{sprint} 14 e \textit{preventivo} \textit{sprint} 15 & Dario Pirrone & Marco Barbiero & Nome Cognome \\ \hline
        1.3.0 & 2026/08/27 & \textit{Consuntivo} \textit{sprint} 13 e \textit{preventivo} \textit{sprint} 14 & Andrea Fistarol & Edoardo Granziero & Nome Cognome\\ \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|c|c|c|c|c|c|c|}
        ...
        Marco Barbiero & - & - & - & 1 & 2 & 1 & \textbf{0} \\ \hline
