...
Il contenimento dei costi annunciato nel \textit{consuntivo} della \textbf{RTB} ha prodotto l'effetto atteso: la riduzione dello \textit{scope} dell'\textbf{MVP} e lo spostamento del lavoro sui ruoli a costo orario ridotto hanno fatto scendere il costo medio orario da \EUR{21,12} della \textbf{RTB} a \EUR{18,13} della \textbf{PB}, permettendo di chiudere in attivo con un costo medio orario di \EUR{19,78}. Il budget del \textbf{Programmatore} resta però in negativo di \EUR{330}, compensato dall'avanzo del \textbf{Verificatore}: lo sforamento si è formato nella fase di test e correzione dell'\textbf{MVP}, quando il costo della rimozione dei difetti si è rivelato superiore a quanto stimato.
