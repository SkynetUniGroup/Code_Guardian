...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|l|l|}
        ...
        0.7 & 2026/05/29 & Scrittura consuntivo Sprint 4 e preventivo Sprint 5; Descritto un nuovo rischio & Sara Ristovic & Edoardo Granziero \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|X|}
        \hline
        \multicolumn{2}{|c|}{\textbf{Communicazione Esterna Inefficace/Inefficiente - RO3}} \\ \hline
        Descrizione & 
        Difficoltà nella comunicazione con il proponente, dovute a tempi di risposta elevati, mancata chiarezza nei messaggi o ritardi nell'organizzazione degli incontri. Questo rischio può rallentare la validazione dei requisiti, la risoluzione di dubbi progettuali e l'avanzamento delle attività che richiedono un riscontro esterno. \ \hline
\\ \hline
...
\\ \hline
        Precauzioni &
        Formulare le richieste al proponente in modo chiaro, completo e tracciabile, preferendo comunicazioni scritte per le decisioni più importanti. Pianificare gli incontri con sufficiente anticipo. Utilizzare i servizi di comunicazione ... \ \hline
\\ \hline
        Mitigazioni possibili & 
        In caso di ritardo nella risposta, il gruppo procede temporaneamente sulla base degli assunti più ragionevoli, esplicitandoli nella documentazione. Se il riscontro esterno è necessario per proseguire, il Responsabile sollecita il Proponente e valuta la ripianificazione delle attività interne o lo spostamento di priorità verso compiti non bloccati dalla comunicazione esterna. \\ \hline
    \end{tabularx}
...
\paragraph{Analisi dei rischi occorsi}
Durante lo \textit{Sprint 4} si è manifestato il rischio relativo alla comunicazione inefficiente con il proponente, identificato come RO3. \\
A causa di tale difficoltà comunicativa, è stato necessario attendere più del previsto per fissare un incontro con l’azienda proponente, finalizzato alla discussione dell'\textbf{Analisi dei Requisiti} e alla ricezione del primo riscontro significativo sul documento. Ciò ha causato un ritardo nello svoglimento del progetto e la necessità di rivalutare alcune scadenze interne.
...
\begin{itemize}
    ...
    Si è deciso di svolgere questo incotro per monitorare meglio l’avanzamento dei compiti dello \textit{Sprint}, pratica che si è rivelata molto utile nello \textit{Sprint} precedente, e per concordare più aspetti importanti.
\end{itemize}


\subsubsection{\textit{Sprint} 5: 26/05/2026 - [data]}
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|c|c|c|c|c|c|c|}
        ...
        \textbf{PG} & \textbf{PR} & \textbf{VE} & \textbf{Totale} \\ \hline
        Andrea Fistarol & & & 0 & & & & \textbf{0} \\ \hline
        Dario Pirrone & & & 7 & & & & \textbf{0} \\ \hline
        Edoardo Granziero & & & & & & 0 & \textbf{0} \\ \hline
        Marco Barbiero & & & & 0 & & & \textbf{0} \\ \hline
        Samuele Bertin & & 0 & & & & & \textbf{0} \\ \hline
        Sara Ristovic & 5 & & & & & & \textbf{0} \\ \hline
        \textbf{Ore totali per ruolo} & \textbf{5} & \textbf{0} &
        \textbf{0} & \textbf{0} & 
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|c|c|c|c|c|c|c|}
        ...
        & \EUR{15} & / \\ \hline
        \textbf{Costo totale} & \EUR{150} & \EUR{0} & \EUR{0} & \EUR{0} & \EUR{0} & 
