...
\begin{tabularx}{\textwidth}{|c|c|X|l|l|}
    ...
    %%%%%%
    0.10.1 & 2026/09/15 & Lettura dell'intero documento e riscrittura di alcune parti per renderle più chiare e fluide  & \makecell[l]{Edoardo Granziero} & \makecell[l]{Sara Ristovic} \\ \hline
    %%%%%%
