...
\begin{tabularx}{\textwidth}{|c|c|X|l|l|}
    ...
    %%%%%%
    1.0.0 & 2026/09/15 & Lettura dell'intero documento e riscrittura di alcune parti per renderle più chiare e fluide  & \makecell[l]{Edoardo Granziero} & \makecell[l]{Sara Ristovic} \\ \hline
    %%%%%%
