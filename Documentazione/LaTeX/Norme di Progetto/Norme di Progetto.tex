...
\end{itemize}
Ogni \textit{commit} deve avere un messaggio conciso e significativo che ne descriva il contenuto. Per ridurre i \textit{conflitti} in fase di \textit{merge}, ogni membro dovrebbe effettuare un \textit{commit} al completamento di ogni piccola unità di lavoro.
