...
presente nel \textit{glossario} è contrassegnato da una G a pedice ed è un
...
I documenti vengono pubblicati sul sito del gruppo. Non tutti i documenti ci sono pubblicati, ma solo quelli relativi alla \textit{milestone} principale corrente (candidatura al \textit{capitolato}, \textbf{RTB}, \textbf{PB}). Tutti i documenti sono comunque presenti nel \textit{repository} \textit{Git} del progetto.\\
...
\textbf{Creazione} - La configurazione dell'infrastruttura va pianificata e documentata.
 ...
 \textit{\glo{Google Sheets}{google-sheets}} - Un\textquotesingle applicazione per fogli di calcolo basata sul \textit{cloud} che consente agli utenti di collaborare sui dati in tempo reale.
