...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{|r|X|}
        ...
        organizzativi & 
        aiutano il buon svolgimento di progetto. Stabiliscono
...
Questa sezione definisce le attività fondamentali necessarie per l'intero ciclo di vita del software, includendo la fornitura del servizio e tutte le fasi tecniche dello sviluppo, dall'analisi dei requisiti alla codifica. Il loro scopo è fornire un percorso operativo strutturato per trasformare le necessità del \textbf{Proponente} in un prodotto software funzionante e conforme alle specifiche.

\subsection{Fornitura}
Questo processo comprende tutte le attività che vanno dalla preparazione della risposta al capitolato del \textbf{Proponente} fino alla consegna del prodotto e alla chiusura del progetto. Le attività sono trasversali e indipendenti dal tema specifico del progetto, poiché rappresentano le fasi in cui il progetto si colloca all'interno del processo di fornitura.
...
Con l'azienda \textbf{Proponente} \textbf{VarGroup} verranno svolte revisioni del progetto e del codice, oltre ad attività di Q\&A in appuntamenti prefissati, in conformità con i processi di revisione e ispezione (\textit{\glo{Audit}{audit}}).\\
Con i \textbf{Committenti}, le revisioni \textbf{\glo{RTB}{rtb}} e \textbf{\glo{PB}{pb}} avverranno nei momenti previsti dal \textit{Regolamento di Progetto} e quando il gruppo comunicherà di essere pronto. Verrà messo a disposizione l'intero \textit{\glo{Repository}{repository}} con tutti gli artefatti, evidenziando i documenti essenziali.
...
Questa sezione descrive le attività che assistono gli altri processi, con l'obiettivo di garantire la qualità, la coerenza e il successo del progetto. Tali processi includono la gestione sistematica della documentazione, il controllo delle configurazioni e le procedure di verifica e validazione necessarie per assicurare che ogni artefatto rispetti gli standard stabiliti.
