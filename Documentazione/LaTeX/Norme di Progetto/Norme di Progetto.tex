...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Fasi: 1-6) Stesse di \textit{Pull Request Check}. 7) \textit{Deploy} su \textit{GitHub Pages}.
...
\paragraph{Ambiente}
\begin{itemize}
    \item \textit{Docker Compose} per servizi esterni (\textit{MongoDB}, \textit{API mock}).
