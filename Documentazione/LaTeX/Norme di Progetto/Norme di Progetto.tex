...
Alcune tecniche di analisi statica del codice sono:

\begin{itemize}
    \item analisi del flusso di controllo,
    \item analisi del flusso dei dati,
    \item verifica dei limiti,
    \item analisi dell'uso dello \textit{stack},
    \item analisi del comportamento temporale.
\end{itemize}
