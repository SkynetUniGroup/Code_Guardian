...
\begin{xltabular}{\textwidth}{|c|c|X|p{2.2cm}|p{2.2cm}|p{2.2cm}|}
\hline
...
\textbf{Ver.} & \textbf{Data} & \textbf{Descrizione} & \textbf{Autore} & \textbf{Verificatore} & \textbf{Approvatore} \\ \hline
\endhead
1.1.1 & 2026/08/21 & Correzioni ai workflow & Andrea Fistarol & Edoardo Granziero & \textemdash{} \\ \hline
1.1.0 & 2026/08/21 & Ampliate e riviste le sezioni Codifica, Struttura Repository, Test di Unità e Test di Integrazione; creata la sezione Strumenti di Build & Andrea Fistarol & Marco Barbiero & \textemdash{} \\ \hline
1.0.1 & 2026/08/21 & Aggiunta versione al riferimento del glossario e aggiunta data di accesso alle risorse web di riferimento & Marco Barbiero & Dario Pirrone & \textemdash{} \\ \hline
1.0.0 & 2026/08/13 & Correzioni e verifica per revisione RTB & Andrea Fistarol & Edoardo Granziero & \textemdash{} \\ \hline
0.10.0 & 2026/08/07 & Riscrittura della sezione 3.2 & Marco Barbiero & Edoardo Granziero & \textemdash{} \\ \hline
0.9.0 & 2026/07/20 & Riscrittura delle sottosezioni Verifica e Validazione & Sara Ristovic & Andrea Fistarol & \textemdash{} \\ \hline
0.8.0 & 2026/07/15 & Riscrittura della sottosezione Documentazione & Sara Ristovic & Andrea Fistarol & \textemdash{} \\ \hline
0.7.1 & 2026/07/15 & Implementazione delle correzioni della verifica dettagliata & Sara Ristovic & Edoardo Granziero & \textemdash{} \\ \hline
0.7.0 & 2026/07/14 & Scrittura della sezione ``Metriche per la Qualità'' (5) & Dario Pirrone & Samuele Bertin & \textemdash{} \\ \hline
0.6.0 & 2026/07/07 & Verifica dettagliata del documento intero & Sara Ristovic & \textemdash{} & \textemdash{} \\ \hline
0.6.0 & 2026/05/23 & Scrittura della sottosezione ``Sviluppo'' (2.2) & Dario Pirrone & Samuele Bertin & \textemdash{} \\ \hline
0.5.0 & 2026/05/13 & Scrittura della sezione ``Processi di Supporto'' & Edoardo Granziero & Dario Pirrone & \textemdash{} \\ \hline
0.4.0 & 2026/05/12 & Scrittura della sottosezione ``Fornitura'' & Andrea Fistarol & Dario Pirrone & \textemdash{} \\ \hline
0.3.0 & 2026/04/27 & Finita la scrittura della sezione ``Processi Organizzativi'' & Sara Ristovic & Marco Barbiero & \textemdash{} \\ \hline
0.2.0 & 2026/04/20 & Scrittura delle sezioni ``Gestione di Processi'' e ``Infrastruttura di Supporto'' & Sara Ristovic & Marco Barbiero & \textemdash{} \\ \hline
0.1.0 & 2026/04/10 & Strutturazione iniziale del documento; scrittura di ``Introduzione'' & Sara Ristovic & Marco Barbiero & \textemdash{} \\ \hline
\end{xltabular}
}
...
\begin{itemize}
    ...
    \item \textit{\glo{Linter}{linter}}: \textit{Biome} (\textit{TS}), \textit{Pylint} (\textit{Python}).
...
\begin{itemize}
    \item \textit{pnpm}: comandi \texttt{pnpm install}, \texttt{pnpm add [package]}, \texttt{pnpm remove [package]}.
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{enumerate}
                ...
                \item Setup Node.js/Python.
                \item Installazione dipendenze.
                \item \textit{\glo{Linting}{linter}}.
                \item Test unitari.
        ...
        \begin{itemize}
            ...
            \begin{enumerate}
                ...
                \item Test di integrazione.
                \item \textit{Build}.
                \item \textit{Deployment} su \textit{AWS}.
            \end{enumerate}
...
\begin{itemize}
    \item Esecuzione con \texttt{pnpm test:unit} in \textit{CI/CD} tramite \textit{GitHub Actions} ad ogni \textit{push} (\textit{workflow} \texttt{ci-staging.yml}) o \textit{Pull Request} (\textit{workflow} \texttt{pr-check.yml}) su \texttt{develop}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textit{CI}: Esecuzione in \textit{CI/CD} con \textit{GitHub Actions} come parte dei \textit{workflow} \texttt{pr-check.yml} (\textit{Pull Request}) e \texttt{ci-staging.yml} (\textit{push} su \texttt{develop}), insieme ai test unitari.
\end{itemize}
