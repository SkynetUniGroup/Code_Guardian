...
\textbf{Creazione} - La configurazione dell'infrastruttura va pianificata e documentata.
 ...
 \textit{Overleaf} - Un editor {\LaTeX} collaborativo basato su \textbf{\glo{cloud}{cloud}}. Utilizzato per la formattazione precisa dei file di documentazione e per il loro affinamento finale. {[}Utilizziamo la versione gratuita che permette la collaborazione di al massimo due persone su un file.{]}
 ...
 \textit{GitHub} - Una piattaforma basata sul cloud che funge da servizio di hosting per i \textit{Repository} \textit{Git}, consentendo agli sviluppatori di archiviare, gestire, condividere e collaborare ai progetti di codice. E' inoltre un sistema di \textit{\glo{ticketing}{ticketing}}.\\
