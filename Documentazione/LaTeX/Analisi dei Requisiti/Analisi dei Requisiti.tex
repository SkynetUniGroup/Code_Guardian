...
\subsubsection{UC 7.1: Creazione del \textit{README} di Progetto}\label{uc:7.1}
...
\subsubsection{UC 7.2: Aggiornamento del \textit{README} di Progetto}\label{uc:7.2}
...
\subsubsection{UC 8.1: Creazione Documentazione Inline (\textit{Docstring}/\textit{JSDoc})}\label{uc:8.1}
...
\subsubsection{UC 8.2: Aggiornamento Documentazione Inline (\textit{Docstring}/\textit{JSDoc})}\label{uc:8.2}
...
\subsubsection{UC 8.3: Errore Documentazione Inline (\textit{Docstring}/\textit{JSDoc})}\label{uc:8.3}
...
\subsubsection{UC 9.1: Creazione Documentazione \textit{API}}\label{uc:9.1}
L'agente estrae le definizioni degli \textit{Endpoint} per creare una guida tecnica per i consumatori delle \textit{API}.
...
\subsubsection{UC 9.2: Aggiornamento Documentazione \textit{API}}\label{uc:9.2}
...
\subsubsection{UC 10: Le modifiche al codice non richiedono aggiornamenti della documentazione}\label{uc:10}
L'agente controlla la coerenza della documentazione \textit{API} dopo una modifica.
