...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di registrazione.
    \item \textbf{Postcondizioni:} Il nome dell'utente è stato valorizzato all'interno del form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di registrazione.
    \item \textbf{Postcondizioni:} Il cognome dell'utente è stato valorizzato all'interno del form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di registrazione.
    \item \textbf{Postcondizioni:} L'indirizzo email dell'utente è stato valorizzato all'interno del form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di registrazione.
    \item \textbf{Postcondizioni:} La password dell'utente è stata valorizzata all'interno del form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di registrazione.
    \item \textbf{Postcondizioni:} Il ruolo operativo scelto è stato selezionato e valorizzato nel form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} L'utente ha inserito un indirizzo email che risulta già associato ad un account esistente nel sistema.
    \item \textbf{Postcondizioni:} Il processo di registrazione viene interrotto. Il sistema mostra un messaggio di errore specifico e l'utente rimane sulla pagina di registrazione.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    \item \textbf{Attore Primario:} Utente non Autenticato.
    \item \textbf{Trigger:} L'utente conferma la volontà di registrarsi cliccando sul pulsante di conferma.
    \item \textbf{Precondizioni:} L'utente ha inserito dei dati che non rispettano le policy di validazione richieste dal sistema.
    \item \textbf{Postcondizioni:} Il processo di registrazione viene interrotto. Il sistema segnala i campi contenenti errori e l'utente rimane sulla pagina di registrazione per poterli correggere.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    \item \textbf{Attore Primario:} Utente non Autenticato.
    \item \textbf{Trigger:} L'utente seleziona il campo di input dedicato all'indirizzo email.
    \item \textbf{Precondizioni:} Il sistema ha caricato e mostra correttamente il modulo di login.
    \item \textbf{Postcondizioni:} L'indirizzo email dell'utente è stato valorizzato all'interno del form.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
        \item L'utente digita il proprio indirizzo email all'interno del campo apposito.
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} L'utente ha inserito una combinazione di indirizzo email e password che non corrisponde ad alcun account registrato.
    \item \textbf{Postcondizioni:} Il processo di autenticazione viene interrotto. L'utente rimane sulla pagina di login e visualizza un messaggio di errore.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema mostra correttamente la schermata di configurazione delle credenziali.
    \item \textbf{Postcondizioni:} Il token del \textit{Repository Git} è stato inserito nel relativo campo di input.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} Il sistema mostra correttamente la schermata di configurazione delle credenziali.
    \item \textbf{Postcondizioni:} Il token del Sistema di Task Management è stato inserito nel relativo campo di input.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} L'utente ha inserito dei token formalmente corretti, ma non validi dal punto di vista logico o autorizzativo sui server esterni.
    \item \textbf{Postcondizioni:} L'operazione di salvataggio viene annullata, le credenziali non vengono memorizzate e il sistema mostra un messaggio di errore dettagliato, mantenendo l'utente sulla pagina corrente.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} L'utente ha lasciato vuoto il campo obbligatorio del \textit{Repository Git}, oppure ha inserito in uno dei campi una stringa che non rispetta il pattern di un token valido.
    \item \textbf{Postcondizioni:} Il sistema blocca la chiamata di test esterna, evidenzia i campi non conformi o mancanti e l'utente rimane sulla pagina per effettuare le correzioni.
    \item \textbf{Scenario Principale:}
    \begin{enumerate}
...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    \hline\
    RQ.7 & Desiderabile & L'interfaccia grafica deve fornire un feedback visivo immediato e non bloccante al cambio di stato di ogni singola operazione, garantendo un'esperienza utente fluida durante le esecuzioni concorrenti. & UC 22, UC 23 \\ 
    \hline
