...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    \hline
    RV.2 & Obbligatorio & Il sistema deve poter operare sui Repository di esempio e sul codice reso disponibile dal Proponente per integrazione e test. & Verbale esterno 2026/03/23 \\
    \hline
    RV.3 & Obbligatorio & [DA ELIMINARE] Il progetto non prevede lo sviluppo dell’Orchestratore né degli agenti dedicati all’aggiornamento delle librerie, alla sostituzione del codice obsoleto al mantenimento della copertura dei test, in quanto già in sviluppo presso Var Group. & Verbale esterno 2026/03/23 \\
    \hline
