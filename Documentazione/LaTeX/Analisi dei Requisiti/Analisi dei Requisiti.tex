...
\subsubsection{UC 1: Gestione del README di Progetto}
...
\begin{itemize}
    ...
    \item \textbf{Scenario Principale}:
        ...
        \end{enumerate}
    \item \textbf{Post-condizioni}: Il file \texttt{README.md} è aggiornato e coerente con l'ultima versione del codice.
\end{itemize}

\subsubsection{UC 2: Generazione Documentazione Inline (Docstring/JSDoc)}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: Il codice sorgente è accessibile; l'Agente 1 ha i permessi di scrittura.
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
        ...
        \end{enumerate}
    \item \textbf{Post-condizioni}: Il codice sorgente contiene documentazione inline aggiornata e conforme agli standard.
...
\subsubsection{UC 3: Generazione Documentazione API}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: Il progetto espone endpoint HTTP; i controller sono mappati correttamente.
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
        ...
        \end{enumerate}
    \item \textbf{Post-condizioni}: Disponibilità di un documento tecnico (\texttt{API.md}) aggiornato per gli stakeholder.
\end{itemize}
