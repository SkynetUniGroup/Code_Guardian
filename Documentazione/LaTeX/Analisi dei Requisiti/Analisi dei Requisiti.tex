...
\begin{itemize}
    \item \textbf{\textit{Attore} Primario}: Sviluppatore.
    \item \textbf{\textit{Attori} Secondari}: \textbf{Orchestratore}, \textit{Repository} \textit{Git}.
    \item \textbf{Trigger}: Lo Sviluppatore effettua un push di modifiche strutturali o richiede l'analisi tramite l'\textbf{Orchestratore}.
    \item \textbf{Precondizioni}: 
        \begin{itemize}
            \item È stato selezionato un \textit{repository} e un riferimento di base (UC 1).
            ...
            \item (Opzionale) Esiste un modello personalizzato per il \textit{README}.
        \end{itemize}
    \item \textbf{Postcondizioni}: È disponibile una proposta di aggiornamento del \texttt{\textit{README}.md} o il file è già aggiornato.
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}:  
        ...
        \end{itemize}
    \item \textbf{Postcondizioni}: Lo Sviluppatore dispone di una proposta di documentazione inline da validare ed è avvertito eventuali problemi.
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}:
        ...
        \end{itemize}
    \item \textbf{Postcondizioni}: È disponibile la proposta di aggiornamento del documento tecnico (\texttt{\textit{API}.md}) o il documento è già aggiornato.
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
