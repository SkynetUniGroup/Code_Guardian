...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{0.14.0} \\ \hline
...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    RV.0 & Obbligatorio & Gli agenti sviluppati devono integrarsi in un’architettura già esistente fornita dal Proponente. & Verbale esterno 2026/03/23 \\
    \hline
    ...
    \hline
    RV.3 & Obbligatorio & Il progetto non prevede lo sviluppo dell’Orchestratore né degli agenti dedicati all’aggiornamento delle librerie, alla sostituzione del codice obsoleto al mantenimento della copertura dei test, in quanto già in sviluppo presso Var Group. & Verbale esterno 2026/03/23 \\
    \hline
