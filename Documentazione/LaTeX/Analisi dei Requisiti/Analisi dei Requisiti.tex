...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Il sistema verifica la corrispondenza delle credenziali inserite con quelle memorizzate in modo sicuro nel database.
        \item Il sistema autentica l'utente, avvia una sessione attiva associata al suo ruolo e lo reindirizza alla dashboard principale.
    \end{enumerate}
    \item \textbf{Sottocasi d'uso):}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo e accessibile.
    \end{itemize}
    \item \textbf{Postcondizioni}:\begin{itemize}\item I token di accesso sono memorizzati in modo sicuro nel sistema e gli agenti sono pronti all'esecuzione.\end{itemize}
    \item \textbf{Scenario Principale}:
        \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}:
    \begin{itemize}
        \item È stato selezionato un r\textit{epository} e un riferimento di base (UC 1).
        \item Il sistema può accedere al contenuto del \textit{repository} selezionato.
    \end{itemize}
    
    \item \textbf{Postcondizioni}:\begin{itemize}\item L'ambito di analisi selezionato è disponibile come input per l'agente interessato.\end{itemize}
...
Questo caso d'uso descrive il processo attraverso il quale l'utente interagisce con l'interfaccia grafica per selezionare deterministicamente una o più operazioni da far svolgere agli agenti.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{Mancata selezione:} Al passo 4, se l'utente tenta di avviare il processo senza aver prima selezionato alcuna operazione, il sistema mostra un messaggio informativo a schermo e richiede di effettuare almeno una selezione per procedere.
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:}
    \begin{itemize}
        \item È stato richiesto l'avvio di una o più \textit{task} tramite l'interfaccia grafica.
