...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    \hline
    RF.6.1 & Desiderabile & Il sistema deve bloccare l'esecuzione di un agente e delegare la visualizzazione di un messaggio d'errore qualora la richiesta superi i limiti di utilizzo API imposti. & UC 5, 11, 13, 15, 16 \\ 
    \hline
