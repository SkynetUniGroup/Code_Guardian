...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{0.15.1} \\ \hline
...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    RQ.6 & Desiderabile & Il processo di verifica delle credenziali e autenticazione non deve superare i 2 secondi, al fine di garantire un'esperienza utente fluida. & UC 21 \\ 
    \hline\
