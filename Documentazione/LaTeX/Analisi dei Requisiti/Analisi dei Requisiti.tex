...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|l|l|}
        ...
        0.6.0 & 2026/05/19 & Aggiunti sottocasi 12.1 e 12.2 dell'UC 14; aggiornata la sezione "Requisiti" & Marco Barbiero & Dario Pirrone \\ \hline
...
\item UC 14.2: Gestione delle ambiguità se l'Agente 4 rileva discrepanze tra titolo e contenuto tecnico.
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: 
        \begin{enumerate}
            \item L'Agente 4 dispone del set di dati delle \textit{User Stories} validato e privo di ambiguità bloccanti (superamento di UC 14.1 e UC 14.2).
...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    \hline
    RF.13 & Obbligatorio & Il sistema deve eseguire un'analisi di sicurezza del codice alla ricerca di vulnerabilità riconducibili alle categorie \textit{OWASP} rilevanti. & UC 11 \\
    \hline
    RF.14 & Obbligatorio & Il sistema deve associare ogni vulnerabilità rilevata almeno al file interessato e, se disponibile, alla porzione di codice coinvolta. & UC 11 \\
    \hline
    RF.15 & Obbligatorio & Il sistema deve classificare le vulnerabilità rilevate indicando almeno categoria \textit{OWASP} e livello di gravità. & UC 11 \\
    \hline
    RF.16 & Obbligatorio & Il sistema deve verificare la conformità del codice rispetto alle policy di sviluppo sicuro definite dal team nel file CLAUDE.md. & UC 12 \\
    \hline
    RF.17 & Obbligatorio & Il sistema deve generare suggerimenti di remediation per vulnerabilità o violazioni di policy rilevate. & UC 13 \\ 
    \hline
    RF.18 & Obbligatorio & Quando la problematica è sufficientemente localizzata nel codice, il sistema deve poter generare uno snippet di codice correttivo da sottoporre a validazione umana. & UC 13.1 \\
    \hline
    RF.19 & Obbligatorio & Quando non è possibile proporre in modo affidabile uno snippet locale, il sistema deve generare una descrizione testuale della remediation da effettuare. & UC 13.2 \\ 
    \hline
    RF.20 & Obbligatorio & Il sistema deve recuperare e filtrare, da un sistema di Task Management esterno, le User Stories e i task completati relativi a uno specifico Sprint. & UC 14 \\
    \hline
    RF.21 & Obbligatorio & Il sistema deve poter identificare lo Sprint di riferimento attraverso la label contenente il codice dello Sprint associata alle issue o ai task. & UC 14, verbale esterno 2026/04/24 \\
    \hline
    RF.22 & Obbligatorio & Il sistema deve estrarre dai task selezionati almeno titolo, descrizione, criteri di accettazione e commenti rilevanti. & UC 14 \\ 
    \hline
    RF.23 & Obbligatorio & Il sistema deve rilevare task con metadati insufficienti e segnalarli all’utente, escludendoli dal flusso di generazione automatica del \textit{Changelog}. & UC 14.1 \\
    \hline
    RF.24 & Obbligatiorio & Il sistema deve rilevare ambiguità o incoerenze tra la documentazione della User Story e i dati tecnici associati, segnalandole all’utente per risoluzione manuale. & UC 14.2 \\
    \hline
    RF.25 & Obbligatorio & Il sistema deve generare un \textit{Changelog} tecnico orientato allo sviluppo, strutturato a partire dai task validati dello Sprint. & UC 15 \\
    \hline
    RF.26 & Obbligatorio &  Il \textit{Changelog} tecnico deve includere i collegamenti ipertestuali e gli identificativi dei ticket di origine, quando tali informazioni sono disponibili. & UC 15 \\
    \hline
    RF.27 & Obbligatorio & Il sistema deve generare un \textit{Changelog} orientato al business, comprensibile a stakeholder non tecnici, a partire dai dati validati dello Sprint e/o dal \textit{Changelog} tecnico. & UC 16 \\
    \hline
...
\begin{xltabular}{12cm}{|c|>{\centering\arraybackslash}X|}
    ...
    RF.13 & [UC 11, \#3.7.1]  \\ \hline
    RF.14 & [UC 11, \#3.7.1]  \\ \hline
    RF.15 & [UC 11, \#3.7.1]  \\ \hline
    RF.16 & [UC 12, \#3.7.2]  \\ \hline
    RF.17 & [UC 13, \#3.7.3]  \\ \hline
    RF.18 & [UC 13.1, \#3.7.3] \\ \hline
    RF.19 & [UC 13.2, \#3.7.3] \\ \hline
    RF.20 & [UC 14, \#3.9.1]  \\ \hline
    RF.21 & [UC 14, \#3.9.1]  \\ \hline
    RF.22 & [UC 14, \#3.9.1]  \\ \hline
    RF.23 & [UC 14.1, \#3.9.1] \\ \hline
    RF.24 & [UC 14.2, \#3.9.1] \\ \hline
    RF.25 & [UC 15, \#3.9.2]  \\ \hline
    RF.26 & [UC 15, \#3.9.2]  \\ \hline
    RF.27 & [UC 16, \#3.9.3]  \\ \hline
    RS.2  & [UC 11, \#3.7.1]  \\ \hline
    RS.3  & [UC 14, \#3.9.1]  \\
\end{xltabular}
\end{center}
\endgroup
