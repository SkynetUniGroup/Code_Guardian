...
\begin{titlepage}
    ...
    \begin{table}[h]
        ...
        \begin{tabularx}{\textwidth}{|l|X|}
            \hline
            \textbf{Versione} & \textit{0.12.1} \\ \hline
...
\item \textbf{Precondizioni}: Il file di \textit{Changelog} Tecnico (UC 18) è stato generato correttamente.
...
\begin{xltabular}{\textwidth}{|c|c|D|F|}
    ...
    \hline
    RF.9 & Obbligatorio & Il sistema deve mostrare un messaggio di errore esplicativo in caso di fallimento durante l’esecuzione di un agente, indicando, ove possibile, una possibile azione correttiva. & UC 5 \\ 
    \hline
