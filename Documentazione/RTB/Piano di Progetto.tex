...
\begin{table}[H]
    \centerline{
        ...
        \begin{tabularx}{1.09\textwidth}{|X|c|c|c|c|c|c|c|}
            ...
            \textbf{Costo orario} & \EUR{30} & \EUR{20} & \EUR{25} & \EUR{25} & \EUR{15} & \EUR{15} & / \\ \hline
            \textbf{Costo totale} & \EUR{120} & \EUR{60} & \EUR{175} & \EUR{0} & \EUR{0} & \EUR{60} & \textbf{\EUR{415}} \\ \hline
            \textbf{Saldo a fine sprint} & \textbf{\EUR{1.470}} & \textbf{\EUR{840}} & \textbf{\EUR{1.225}} 
            & \textbf{\EUR{2.700}} & \textbf{\EUR{2.070}} & \textbf{\EUR{2.175}} & \textbf{\EUR{10.480}}\\ \hline
        \end{tabularx}
    }
...
\begin{itemize}
    ...
    \item \textbf{Mitigazione:} Per risolvere tempestivamente l'intoppo, il gruppo ha aumentato la frequenza dei brevi meeting di allineamento interni (\textit{Daily Scrum} informali). Questa misura ha permesso di ridistribuire il carico di lavoro in tempo reale, garantendo agli Analisti le linee guida necessarie per procedere senza ulteriori blocchi.
\end{itemize}
