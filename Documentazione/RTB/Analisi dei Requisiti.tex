...
\begin{itemize}
\item \textbf{Attore Primario}: Stakeholder / Cliente.
\item \textbf{Attori Secondari}: Orchestratore, Modello AI (LLM).
\item \textbf{Precondizioni}: Disponibilità dei dati dello Sprint; configurazione dell'audience (UC 12.5).
\item \textbf{Scenario Principale}:
\begin{enumerate}
...
\subsubsection{UC 13.5: Validazione Formato Output AI}
...
\subsubsection{UC 14.4: Esportazione Report Multiformato}
